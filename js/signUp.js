// login form
const input_login_username = document.querySelector("#input_login_username");
const input_login_password = document.querySelector("#input_login_password");
const error_msg_login = document.getElementById("error_msg_login");
...
// register form
const input_register_username = document.querySelector("#input_register_username");
const input_register_email = document.querySelector("#input_register_email");
const input_register_password = document.querySelector("#input_register_password");
const error_msg_register = document.getElementById("error_msg_register");
const check_box = document.getElementById("reg-check-box");
...
function login() {
    ...
    register_form.style.left = "500px";
...
function validateRegisterForm(){
	...
	if(!checkUserName(input_register_username.value)) {
        setErrorRegister("inline-block","Login musi zawierać conajmniej 5 znaków w tym 1 dużą literę.");
        return false;
    }

    // show the error msg
	if(!isValidEmail(input_register_email.value)){
		setErrorRegister("inline-block","Wpisz poprawny e-mail.");
		return false;
	}

	// show the error msg
	if(!checkPassword(input_register_password.value)){
		var msg = "Hasło musi zawierać conajmniej 1 cyfrę oraz 1 dużą literę.";
...
function validateLoginForm(){
	...
	if(!checkUserName(input_login_username.value)) {
        setErrorLogin("inline-block","Login musi zawierać conajmniej 5 znaków w tym 1 dużą literę.");
        return false;
    }
